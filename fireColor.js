...
if (canvas) {
  ...
  function getWebGLContext(e) {
    ...
    let i, o;
    t ||
      (r = e.getContext("webgl", n) || e.getContext("experimental-webgl", n)),
      t
  ...
  function initFramebuffers() {
    ...
    (A = createDoubleFBO(
      ...
      (U = createDoubleFBO(6, E, S, v.internalFormat, v.format, o, t.NEAREST));
  }
  ...
  function step(n) {
    ...
    for (let n = 0; n < e.PRESSURE_ITERATIONS; n++)
      t.bindTexture(t.TEXTURE_2D, U.read.texture), x(U.write.fbo), U.swap();
    z.bind(),
  ...
  function splat(n, r, i, o, a) {
    t.viewport(0, 0, E, S),
      ...
      t.uniform2f(P.uniforms.point, n / canvas.width, 1 - r / canvas.height),
